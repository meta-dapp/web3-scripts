...
$(function () {
	...
	new PerfectScrollbar(".header-message-list"), new PerfectScrollbar(".header-notifications-list"), $(".mobile-search-icon").on("click", function () {
		...
		var dark = !_class.includes('sun')
		$("html").attr("class", dark ? "dark-theme" : "light-theme")
		$("#change-theme").attr("class", !dark ? "bx bx-moon theme-font" : "bx bx-sun theme-font")
